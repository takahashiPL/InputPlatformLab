...
#endif
// T59: Windowed かつ clientH がこれ以下のとき T14 を優先し T15/T16/T18/T17 を compact、最低 3 行の visible modes を狙う
...
#endif
// T64: fill-monitor Fullscreen のみ、row1↔row2 / row2↔本文 / menu↔T14 を詰めて restTop を下げ scrollVpH を増やす（Borderless / Windowed は既定のまま）
#ifndef WIN32_OVERLAY_T64_FULLSCREEN_ROW1_GAP_PX
#define WIN32_OVERLAY_T64_FULLSCREEN_ROW1_GAP_PX 4
#endif
#ifndef WIN32_OVERLAY_T64_FULLSCREEN_ROW2_TO_BODY_GAP_PX
#define WIN32_OVERLAY_T64_FULLSCREEN_ROW2_TO_BODY_GAP_PX 12
#endif
